 ...
 * Message object.
 */
@ApiModel(description = "Message object.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Message {
  ...
  **/
  ...
  @ApiModelProperty(value = "The [client ID](https://www.ably.io/documentation/core-features/authentication#identified-clients) of the publisher of this message.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The connection ID of the publisher of this message.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The string encoded payload, with the encoding specified below.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This will typically be empty as all messages received from Ably are automatically decoded client-side using this value. However, if the message encoding cannot be processed, this attribute will contain the remaining transformations not applied to the data payload.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A Unique ID that can be specified by the publisher for [idempotent publishing](https://www.ably.io/documentation/rest/messages#idempotent).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The event name, if provided.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Timestamp when the message was received by the Ably, as milliseconds since the epoch.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, connectionId, data, encoding, extras, id, name, timestamp, additionalProperties);
  }
