 ...
 */
@ApiModel(description = "Returned error from failed REST.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Error {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Link to help with error.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Message explaining the error's cause.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Server ID with which error was encountered.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Status error code.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, href, message, serverId, statusCode, additionalProperties);
  }
